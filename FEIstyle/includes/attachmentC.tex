...
V koreňovom priečinku teda \textit{Scan2Control} otvorte dva terminály a spustite:

\begin{lstlisting}[style=code-listing, language=bash]
...
Backend bude dostupný na porte \textbf{8000}, asistent na porte \textbf{8100}. Backend pri prvom štarte automaticky vytvorí databázové tabuľky, založí preddefinované účty a zaregistruje testovacie zariadenie \emph{Dopravník} s ArUco~ID~1.
