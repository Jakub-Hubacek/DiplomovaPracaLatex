...
\begin{description}
    ...
    \item[NFP2: Spoľahlivosť komunikácie] - Prenos správ medzi mobilnou aplikáciou a edge zariadením musí prebiehať cez protokol MQTT s úrovňou kvality služieb QoS 1 (\textit{At least once}) alebo QoS 2.
