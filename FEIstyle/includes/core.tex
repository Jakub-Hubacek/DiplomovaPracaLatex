...
Táto kapitola poskytuje teoretický prehľad technológií a frameworkov pre vývoj mobilných, webových a backendových aplikácií s dôrazom na ich integráciu do priemyselných riadiacich systémov. Výber technológií zohľadňuje požiadavky na výkon, škálovateľnosť a spoľahlivosť v prostredí Industry 4.0.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Ekosystém NPM:} Prístup k tisícom knižníc pre správu stavu (Redux, Zustand) a vizualizáciu dát.
        \item \textbf{Nová architektúra (JSI):} Odstránenie asynchrónneho bridge-u v prospech priameho volania C++ objektov výrazne zlepšilo odozvu pri interakcii s PLC dátami.
    \end{itemize}
    \item \textbf{Nevýhody:}
    \begin{itemize}
