...
Tento projekt predstavuje moderný prístup k priemyselnému internetu vecí (IIoT),
...
pričom ich použitie v~kombinácii s~jednoznačnou identifikáciou zariadení otvára cestu
