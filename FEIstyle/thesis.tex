...
% Rozšírenie miesta pre dvojciferné čísla subsekcií v obsahu
...
\FEIlistOfAppendix
%% Attachment A
\FEIappendix{Štruktúra elektronického nosiča\label{att:filesystem}}{includes/attachmentA}

%% Attachment B
\FEIappendix{Testovacie otázky\label{att:testing}}{includes/attachmentB}

%% Attachment C
\FEIappendix{Návod na spustenie\label{att:launch}}{includes/attachmentC}

%% Attachement D
%%\FEIappendix{Obrázky v anglickom jazyku a zdrojový kód diagramov \label{att:engimgs}}{includes/attachmentD}
